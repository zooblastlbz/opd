...
# To switch back to a remote teacher server, set `TEACHER_BACKEND=server`.
#
...
TEACHER_BACKEND=${TEACHER_BACKEND:-local}
...
OFFLOAD_TEACHER_MODEL=${OFFLOAD_TEACHER_MODEL:-true}
GKD_LOGITS_TOPK=${GKD_LOGITS_TOPK:-16}
DATASET=${DATASET:-open-r1/DAPO-Math-17k-Processed}
OUTPUT_DIR=${OUTPUT_DIR:-output/Qwen3-8B-GRADE-Gated-DAPO-Math-17k-Teacher}
