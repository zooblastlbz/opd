...
# Default: pure-RL GRPO baseline with colocated vLLM rollout.
# Multi-node: set NNODES/NODE_RANK/MASTER_ADDR/MASTER_PORT and the script will switch to torchrun.
...
OUTPUT_DIR=${OUTPUT_DIR:-output/Qwen3-8B-GRPO-DAPO-Math-17k}
...
# Set BETA>0 to enable GRPO ref-KL regularization.
BETA=${BETA:-0.0}
# Set >0 to include extra ref top-k vocab tokens in the surrogate KL.
