...
# OPSD baseline with privileged teacher_prompt built from the gold solution.
...
OPSD_MODE=${OPSD_MODE:-dynamic}
OUTPUT_DIR=${OUTPUT_DIR:-output/Qwen3-8B-OPSD-DAPO-Math-17k}
